...
export default function StudentSubmissionsPage() {
  ...
  const renderStudentWork = (content) => {
    ...
    try {
      ...
      if (parsed?.task?.nodes || parsed?.nodes) {
        return (
          <div className="bg-slate-950 p-8 rounded-[32px] border border-slate-800 text-center">
            ...
            <div className="text-xs text-slate-400 italic bg-slate-900/50 p-4 rounded-xl border border-slate-800/50">
              Siswa telah menyusun diagram alur.
            </div>
          </div>
        );
      }
      ...
      // 3. DETEKSI LINK GAMBAR / FALLBACK
  ...
  if (loading) return (
    <div className="h-screen bg-slate-950 flex flex-col items-center justify-center text-blue-500">
      ...
      <p className="uppercase tracking-widest text-[10px] font-black">Menganalisis Jawaban...</p>
    </div>
  );
    ...
    <div className="p-6 md:p-10 bg-slate-950 min-h-screen text-white font-sans">
      ...
      <div className="max-w-6xl mx-auto space-y-10">
        {submissions.length > 0 ? (
          submissions.map((sub) => (
            <div key={sub.submission_id} className="bg-slate-900/40 border border-slate-800 rounded-[45px] overflow-hidden shadow-2xl">
              ...
              <div className="p-8 border-b border-slate-800/50 flex flex-col md:flex-row justify-between items-center gap-4 bg-slate-900/20">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <h3 className="text-2xl font-black tracking-tight">{sub.student_name}</h3>
                  ...
                  <div className="flex flex-col lg:flex-row gap-10">
                    ...
                    <div className="w-full lg:w-64 flex flex-col justify-between space-y-6">
                      ...
                      <button 
                        ...
                        className="w-full bg-blue-600 hover:bg-blue-500 py-5 rounded-2xl font-black text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-3 transition-all shadow-xl shadow-blue-900/40 active:scale-95"
                      >
          ...
          <div className="text-center py-32 bg-slate-900/10 rounded-[60px] border border-dashed border-slate-800">
